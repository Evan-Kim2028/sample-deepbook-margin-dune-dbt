...
{# Event: 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::AssetSupplied #}
...
with raw_events as (
    ...
    where event_type = '0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::AssetSupplied'
    {% if is_incremental() %}
...
select
    ...
    try_cast(json_extract_scalar(event_json, '$.supply_amount') as double) as supply_amount,
    try_cast(json_extract_scalar(event_json, '$.supply_shares') as double) as supply_shares,
