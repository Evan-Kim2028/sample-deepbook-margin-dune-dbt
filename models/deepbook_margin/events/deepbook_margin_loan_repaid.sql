...
{# Event: 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_manager::LoanRepaidEvent #}
...
with raw_events as (
    ...
    where event_type = '0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_manager::LoanRepaidEvent'
    {% if is_incremental() %}
...
select
    ...
    try_cast(json_extract_scalar(event_json, '$.repay_shares') as double) as repay_shares,
